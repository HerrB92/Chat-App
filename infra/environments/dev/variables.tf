...
# Shared resources (from bootstrap outputs)
...
# GitHub Actions Service Principal Object ID (for Key Vault Secrets Officer role)
variable "github_sp_object_id" {
  type    = string
  default = ""
}

# Entra configuration (from AZURE_SETUP.md Step 3)
